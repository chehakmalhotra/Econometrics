...
ground_water_df <- read.csv("/Users/chehakmalhotra/Desktop/NDAP_REPORT_7063.csv")
...
sdp_df <- read.csv("/Users/chehakmalhotra/Downloads/SDP 2.csv")
...
gini_df <- read.csv("/Users/chehakmalhotra/Desktop/GINI.csv")
...
fem_df=read.csv("/Users/chehakmalhotra/Downloads/Female worker population_new - Sheet1.csv")
colnames(fem_df)[2] <- "Yearcode"
df_merge_3 <- merge(x=df_merge_2, y=fem_df, by=c("State","Yearcode"))

winmarg <-read.csv("/Users/chehakmalhotra/Downloads/Marginelecnew.csv")
winmarg <-winmarg[ -c(1) ]
...
sc_crime<-read.csv("/Users/chehakmalhotra/Downloads/SC_Crimes_newupdate - Table1.csv")
...
rainfall_df <- read.csv("/Users/chehakmalhotra/Downloads/rainfall_new1.csv")
...
write.csv(df,"/Users/chehakmalhotra/Downloads/group_15.csv", row.names = FALSE)
...
gini2_df <- read.csv("/Users/chehakmalhotra/Downloads/Gini_New1.csv")
